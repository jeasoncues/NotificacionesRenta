...
$sDestination = '+51999134381';
//$sDestination = array('346xxxxxxxx','346yyyyyyyy');

$response = $altiriaSMS->sendSMS($sDestination, "Sistema Usqay le informa, que el día 03 de Septiembre se le vence el plan de Usqay Restaurante.");
